    ...
    <>
      <div className="bg-black_900 flex flex-col font-spacegrotesk gap-[120px] md:gap-[40px] sm:gap-[40px] items-center justify-end mx-[auto] pt-[30px] w-[100%]">
          ...
          <header className="flex items-center justify-center w-[100%]">
            <div className="flex flex-1 md:flex-col flex-row md:gap-[20px] items-center justify-center w-[100%]">
              ...
              <div className="flex md:flex-1 flex-row sm:hidden items-start justify-center md:w-[100%] w-[30%]">
                ...
                <Text
                  className="common-pointer font-medium ml-[23px] mt-[2px] text-bluegray_100 text-left w-[auto]"
                  as="h6"
                  variant="h6"
        ...
        <footer className="bg-gray_901 flex items-center justify-center w-[100%]">
          <div className="flex sm:flex-col flex-row md:gap-[40px] sm:gap-[40px] items-center justify-between mx-[auto] my-[27px] w-[74%]">
            <div className="flex flex-col items-start justify-start sm:w-[100%] w-[auto]">
              <div className="flex flex-row gap-[14px] items-center justify-start md:w-[100%] sm:w-[100%] w-[82%]">
                <Img
                  src="images/img_television.svg"
                  className="h-[50px] w-[50px]"
                  alt="television One"
              ...
              <div className="flex flex-col gap-[18px] items-start justify-start md:ml-[0] sm:ml-[0] ml-[2px] mt-[24px] md:w-[100%] sm:w-[100%] w-[55%]">
                <Text
              ...
              <Text
                className="font-normal md:ml-[0] sm:ml-[0] ml-[3px] mt-[67px] not-italic text-bluegray_200 text-left w-[auto]"
                variant="body2"
              >
                2022 Stocky all rights reserved
              </Text>
            </div>
            <ul className="flex flex-col items-start justify-start md:w-[100%] sm:w-[100%] w-[auto] common-column-list">
              <li className="w-[auto]">
                <Text
